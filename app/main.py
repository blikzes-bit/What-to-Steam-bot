...
async def main() -> None:
    ...
    await bot.set_my_commands(
        [
            ...
            BotCommand(command="deals", description="Выгодные предложения"),
            BotCommand(command="releases", description="Новые релизы"),
            BotCommand(command="digest", description="Ежедневная подборка"),
